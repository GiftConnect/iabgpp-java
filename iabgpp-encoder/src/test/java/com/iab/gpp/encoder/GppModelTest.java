...
public class GppModelTest {
    ...
    private final ZonedDateTime utcDateTime = ZonedDateTime.of(2022, 1, 1, 0, 0, 0, 0, ZoneId.of("UTC"));

    @Test
    public void testEncodeDefault() {
        GppModel gppModel = new GppModel();
        Assertions.assertFalse(gppModel.hasSection(UspV1.ID));
        Assertions.assertFalse(gppModel.hasSection(TcfEuV2.ID));
        Assertions.assertFalse(gppModel.hasSection(TcfCaV1.ID));

        Assertions.assertFalse(gppModel.hasSection(UspV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(TcfEuV2.NAME));
        Assertions.assertFalse(gppModel.hasSection(TcfCaV1.NAME));
    ...
    public void testDecodingException() {
        Assertions.assertThrows(DecodingException.class, () -> new GppModel("invalid gpp string").getHeader());
    }

    @Test()
    public void testDecodeGarbage() {
        Assertions.assertThrows(DecodingException.class, () -> new GppModel("z").getUsCtV1Section());
    }
    ...
    public void testEncodeDefaultAll() {
        ...
        Assertions.assertFalse(gppModel.hasSection(TcfCaV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UspV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsNatV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsCaV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsVaV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsCoV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsUtV1.NAME));
        Assertions.assertFalse(gppModel.hasSection(UsCtV1.NAME));
        ...
        Assertions.assertTrue(gppModel.hasSection(TcfEuV2.NAME));
        Assertions.assertTrue(gppModel.hasSection(TcfCaV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UspV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsNatV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsCaV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsVaV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsCoV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsUtV1.NAME));
        Assertions.assertTrue(gppModel.hasSection(UsCtV1.NAME));
    ...
    public void testEncodeUspv1() {
        ...
        Assertions.assertEquals(List.of(6), gppModel.getSectionIds());
        Assertions.assertTrue(gppModel.hasSection(UspV1.ID));
        Assertions.assertFalse(gppModel.hasSection(TcfEuV2.ID));
        Assertions.assertFalse(gppModel.hasSection(TcfCaV1.ID));
    ...
    public void testEncodeTcfEuV2() {
        ...
        Assertions.assertEquals(List.of(2), gppModel.getSectionIds());
        Assertions.assertFalse(gppModel.hasSection(UspV1.ID));
        Assertions.assertTrue(gppModel.hasSection(TcfEuV2.ID));
        Assertions.assertFalse(gppModel.hasSection(TcfCaV1.ID));
    ...
    public void testEncodeUspV1AndTcfEuV2AndTcfCaV1() {
        ...
        Assertions.assertTrue(gppModel.hasSection(UspV1.ID));
        Assertions.assertTrue(gppModel.hasSection(TcfEuV2.ID));
        Assertions.assertTrue(gppModel.hasSection(TcfCaV1.ID));
    ...
    public void testEncode1() {
        ...
        gppModel.setFieldValue(TcfEuV2.NAME, TcfEuV2Field.VENDOR_CONSENTS, List.of(28));
    ...
    public void testEncode2() {
        ...
        gppModel.setFieldValue(TcfEuV2.NAME, TcfEuV2Field.VENDOR_CONSENTS, List.of(29));
        gppModel.setFieldValue(TcfEuV2.NAME, TcfEuV2Field.CREATED, utcDateTime);
        gppModel.setFieldValue(TcfEuV2.NAME, TcfEuV2Field.LAST_UPDATED, utcDateTime);
    ...
    public void testDecode1() {
        ...
        Assertions.assertEquals(List.of(28), gppModel.getFieldValue(TcfEuV2.NAME, TcfEuV2Field.VENDOR_CONSENTS));
    }

    @Test
    public void testDecode2() {
        GppModel gppModel = new GppModel("DBABMA~CPSG_8APSG_8AAAAAAENAACAAAAAAAAAAAAAAOwAQAOgAAAA.QAAA.IAAA");
        Assertions.assertEquals(List.of(29), gppModel.getFieldValue(TcfEuV2.NAME, TcfEuV2Field.VENDOR_CONSENTS));
    }
    ...
    @Test
    public void testDecodingTCFString() {
        GppModel model = new GppModel("CP3MC8AP3MC8APoABAENDgCAAAAAAAAAAIwIAAAAAAAA.QAAA.IAAA");
        Assertions.assertEquals(2, model.getFieldValue(TcfEuV2.NAME, TcfEuV2Field.VERSION));
        Assertions.assertEquals(1, model.getFieldValue(TcfEuV2.NAME, TcfEuV2Field.CMP_VERSION));
        Assertions.assertEquals(1000, model.getFieldValue(TcfEuV2.NAME, TcfEuV2Field.CMP_ID));
    }

    @Test
    public void testDecodingGarbage() {
        Assertions.assertThrows(DecodingException.class, () -> new GppModel("xyAFz220~r").getUsCtV1Section());
    }

    @Test
    public void testDecdoingCanadianTCFString() {
        GppModel model = new GppModel("DBABjw~CPXxRfAPXxRfAAfKABENB-CgAAAAAAAAAAYgAAAAAAAA~1YNN");
        Assertions.assertTrue(model.hasSection(UspV1.ID));
        Assertions.assertFalse(model.hasSection(TcfEuV2.ID));
        Assertions.assertTrue(model.hasSection(TcfCaV1.ID));
    }
}
